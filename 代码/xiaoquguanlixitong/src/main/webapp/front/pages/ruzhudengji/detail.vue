<template>
	<mescroll-uni @init="mescrollInit" :up="upOption" :down="downOption" @down="downCallback" @up="upCallback"
		...
		<view class="container">
			...
			<!-- 名字-->
						<view :style='{"textAlign":"left","fontSize":"45upx","color":"black"}'>{{detail.ruzhudengjiName}}
						</view>
				</view>
   	 <view style="margin-top: 10rpx;"></view>
					...
					<view class="detail-list-item"
                        ...
                        <view class="lable"
							...
							入住时间：</view>
                        <view class="text" :style='{"color":"#008761","textAlign":"center","fontSize":"24rpx"}'>
                            {{detail.ruzhudengjiShijian}}</view>
                    </view>
					<view class="detail-list-item"
                          :style='{"boxShadow":"0 0 4rpx 0 #006633 insta","margin":"0 60rpx 0 60rpx","borderColor":"rgba(218, 218, 218, 1)","backgroundColor":"#fff","borderRadius":"0","borderWidth":"2rpx","borderStyle":"none none solid none ","height":"68rpx"}'>
                        <view class="lable"
							...
							入住人员：</view>
                        <view class="text" :style='{"color":"#008761","textAlign":"center","fontSize":"24rpx"}'>
                            {{detail.ruzhudengjiRenyuan}}</view>
                    </view>
			</view>
			<view class="time-content"
				...
				<view class="content" style="line-height: 50upx;letter-spacing: 5upx;"
					...
					<rich-text :nodes="detail.ruzhudengjiContent"></rich-text>
				</view>
			</view>
...
<script>
	export default {
		...
		methods: {
			...
			// 获取详情
			async init() {
				let res = await this.$api.info('ruzhudengji', this.id);
				this.detail = res.data;
				// 主图
				this.swiperList = this.detail.ruzhudengjiPhoto ? this.detail.ruzhudengjiPhoto.split(",") : [];
			},
