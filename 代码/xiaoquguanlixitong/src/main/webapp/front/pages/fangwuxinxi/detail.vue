<template>
	<mescroll-uni @init="mescrollInit" :up="upOption" :down="downOption" @down="downCallback" @up="upCallback"
		...
		<view class="container">
			...
			<!-- 名字-->
						<view :style='{"textAlign":"left","fontSize":"45upx","color":"black"}'>{{detail.fangwuxinxiName}}
						</view>
				</view>
   	 <view style="margin-top: 10rpx;"></view>
			...
			<view class="time-content"
				...
				<view class="content" style="line-height: 50upx;letter-spacing: 5upx;"
					...
					<rich-text :nodes="detail.fangwuxinxiContent"></rich-text>
				</view>
			</view>
	...
	export default {
		...
		methods: {
			...
			async init() {
				...
				// 主图
				this.swiperList = this.detail.fangwuxinxiPhoto ? this.detail.fangwuxinxiPhoto.split(",") : [];
			},
