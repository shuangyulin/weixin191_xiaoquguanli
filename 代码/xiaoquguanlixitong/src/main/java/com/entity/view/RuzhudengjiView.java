...
public class RuzhudengjiView extends RuzhudengjiEntity implements Serializable {
    private static final long serialVersionUID = 1L;
		...
		* 入住房屋类型的值
		*/
		private String ruzhudengjiValue;
	...
	public RuzhudengjiView(RuzhudengjiEntity ruzhudengjiEntity) {
		try {
			...
			* 获取： 入住房屋类型的值
			*/
			public String getRuzhudengjiValue() {
				return ruzhudengjiValue;
			}
			/**
			* 设置： 入住房屋类型的值
			*/
			public void setRuzhudengjiValue(String ruzhudengjiValue) {
				this.ruzhudengjiValue = ruzhudengjiValue;
			}
